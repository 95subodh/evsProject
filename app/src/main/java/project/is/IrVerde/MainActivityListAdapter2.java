 ...
 */
public class MainActivityListAdapter2 extends RecyclerView.Adapter<MainActivityListAdapter2.ViewHolder>{
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            switch (position){
                case 0: mToast = Toast.makeText(mContext,"item 0 clicked",Toast.LENGTH_SHORT);mToast.show();
...
//            int id=getPosition();
    ...
    public MainActivityListAdapter2(Context context, ArrayList<MainActivityListItem> items) {
//        super(context, android.R.layout.simple_list_item_1, items);
    ...
    @Override
    public MainActivityListAdapter2.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                 int viewType) {
        // create a new view
